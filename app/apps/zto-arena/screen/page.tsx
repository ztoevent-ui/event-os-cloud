    ...
    <div className="min-h-screen bg-black text-white font-sans overflow-hidden flex flex-col relative select-none cursor-none">
      ...
      <AnimatePresence mode="wait">
        {isAdMode && activeAd ? (
          ...
          <motion.div key="loading" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex-1 flex flex-col items-center justify-center z-10">
          ...
          <motion.div key="scoreboard" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex-1 flex flex-col z-10">
            ...
            <main className="flex-1 flex w-full relative">
              {/* Central Element for specific sports */}
