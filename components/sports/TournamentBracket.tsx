...
export function TournamentBracket({ matches, players, tournament }: TournamentBracketProps) {
    // 1. Group matches by round for bracket
    ...
    return (
        <div className="w-full h-full flex flex-col items-center bg-[#f7ebe6] rounded-3xl overflow-hidden shadow-2xl relative font-sans">
            {/* Header section like the image */}
            <div className="w-full h-32 bg-white flex flex-col justify-center items-center relative border-b-4 border-[#dc3137]">
            ...
            {/* Main Bracket Area */}
            <div className="flex-1 w-full flex items-stretch justify-center p-8 relative overflow-x-auto overflow-y-hidden">
                <div className="min-w-[1400px] h-full flex items-center justify-between relative px-12 pb-12">
